...
use BitCode\BitFormPro\Integration\ZohoMarketingHub\RecordApiHelper;
...
class ZohoMarketingHubHandler
{
    ...
    {
        add_action('wp_ajax_bitforms_zmarketingHub_generate_token', array(__CLASS__, 'generateTokens'));
        add_action('wp_ajax_bitforms_zmarketingHub_refresh_lists', array(__CLASS__, 'refreshListsAjaxHelper'));
        add_action('wp_ajax_bitforms_zmarketingHub_refresh_contact_fields', array(__CLASS__, 'refreshContactFieldsAjaxHelper'));
    }
    ...
    public function execute(IntegrationHandler $integrationHandler, $integrationData, $fieldValues, $entryID, $logID)
    {
        ...
        if (
            ...
            return new WP_Error('REQ_FIELD_EMPTY', __('list are required for zoho marketingHub api', 'bitform'));
        }
