...
class AutonamiHandler
{
  ...
  public static function checkedExistsAutonami()
  {
    if (!class_exists('BWFCRM_Contact')) {
      wp_send_json_error(__('Autonami Pro Plugins not found', 'bitform'), 400);
    } else {
      return true;
    }
  }
  ...
  public function execute(IntegrationHandler $integrationHandler, $integrationData, $fieldValues, $entryID, $logID)
  {
    ...
    if (empty($fieldMap)) {
      return new WP_Error('REQ_FIELD_EMPTY', __('module, fields are required for Autonami api', 'bitform'));
    }
