...
if( ! class_exists( 'CSF_Field_cz_sk_free' ) ) {

	class CSF_Field_cz_sk_free extends CSF_Fields {
	  ...
	  <div>
		<form>
		  <?php 
			...
			echo '<div class="col s12 ' . ( $free ? 'xtra-readonly' : '' ) . '">' . csf_add_field( array(
			  'id'      => 'font-family',
			  'name'    => 'font-family',
			  'type'    => 'select_font',
			...
			echo '<div class="col s4">' . csf_add_field( array(
			  'id'      => 'display',
			  'name'    => 'display',
			  'type'    => 'select',
